...
public class GSquare extends Application {
    ...
    private static String[]       prefixes    =
            {"Intro to ", "Intermediate ", "Advanced ", "Remedial "};
    private static String[]       adjectives  = {"Molecular ", "Watercolor ",
            "Astro-", "Organic ", "Theoretical ", "Quantum "};
    private static String[]       core        = {"Java", "Biology", "Physics",
            "Painting", "Python", "Chemistry", "History", "Memeology"};

    // User Names
    private static String[]       firstNames  = {"Sophia", "Liam", "Olivia",
            "Aiden", "Emma", "Timothy", "Ava", "Arnold"};
    private static String[]       lastNames   =
            {"Clark", "Hall", "Miller", "Smith", "Walker", "Adams", "Scott"};

    // Schools
    private static String[]       schools     = {"Georgia Tech", "MIT",
            "Stanford", "UCSD", "Yale", "UGA", "USC", "Harvard"};
    ...
    private Student genStudent() {
        ...
        if (rand.nextDouble() > .2) {
            ...
            // If you get an error / exception here, check your constructor!
            student = new Undergrad(name, rand.nextInt(150), rand.nextBoolean(),
                    standing);
    ...
    public void start(Stage stage) {
        ...
        control.getChildren().addAll(courseButton, userButton, instructorButton,
                alumniButton, studentButton, undergradButton, gradButton);
    ...
    private TableView<Instructor>
            createInstructorTable(ArrayList<Instructor> tableInstructors) {
        ...
        teachingCol
                .setCellValueFactory(new PropertyValueFactory("yearsTeaching"));
        ...
        almaMaterCol.setCellValueFactory(new PropertyValueFactory("almaMater"));
    ...
    private TableView<Alumnus>
            createAlumnusTable(ArrayList<Alumnus> tableAlumnus) {
        // Setup table
        ...
        TableColumn<Alumnus, Integer> gradYearCol =
                new TableColumn<>("Graduation Year");
        gradYearCol.setCellValueFactory(new PropertyValueFactory("gradYear"));
        TableColumn<Alumnus, String> typeCol = new TableColumn<>("Type");
        typeCol.setCellValueFactory(new PropertyValueFactory("type"));
    ...
    private TableView<Student>
            createStudentTable(ArrayList<Student> tableStudents) {
        ...
        TableColumn<Student, String> typeCol = new TableColumn<>("Type");
        typeCol.setCellValueFactory(new PropertyValueFactory("type"));
    ...
    private TableView<Undergrad>
            createUndergradTable(ArrayList<Undergrad> tableUndergrads) {
    ...
    private TableView<Course>
            createCourseTable(ArrayList<Course> tableCourses) {
        // Setup table
        ...
        TableColumn<Course, String> nameCol =
                new TableColumn<Course, String>("Name");
        nameCol.setCellValueFactory(new PropertyValueFactory("name"));
        TableColumn<Course, String> courseCol =
                new TableColumn<Course, String>("Course Code");
        courseCol.setCellValueFactory(new PropertyValueFactory("courseCode"));
        TableColumn<Course, String> instCol =
                new TableColumn<Course, String>("Instructor");
        instCol.setCellValueFactory(new PropertyValueFactory("instructorName"));
